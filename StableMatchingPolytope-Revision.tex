...
\begin{proof}
  ...
  Since $M_1$ and $M_2$ are stable, $a$ and $b$ lie in $V(J_1)\cup V(J_2)$. Similarly, $a$ and $b$ cannot both lie in $V(J_1)$ or both in  $V(J_2)$. Suppose first that $a \in V(J_1)$ and $b \in V(J_2)$. In this case $M'_1(a)=M_2(a)$ and
